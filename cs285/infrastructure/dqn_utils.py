...
# register customized environments from /envs 
...
def register_custom_envs():
    ...
    register(
        id='HalfCheetah_A',
        entry_point='cs285.envs.cheetah.cheetah_A:HalfCheetah_A',
        max_episode_steps=1000,
    )

    register(
        id='HalfCheetah_B',
        entry_point='cs285.envs.cheetah.cheetah_B:HalfCheetah_B',
        max_episode_steps=1000,
    )

    register(
        id='HalfCheetah_C',
        entry_point='cs285.envs.cheetah.cheetah_C:HalfCheetah_C',
        max_episode_steps=1000,
    )

    register(
        id='HalfCheetah_D',
        entry_point='cs285.envs.cheetah.cheetah_D:HalfCheetah_D',
        max_episode_steps=1000,
    )

    register(
        id='HalfCheetah_E',
        entry_point='cs285.envs.cheetah.cheetah_E:HalfCheetah_E',
        max_episode_steps=1000,
    )

    register(
        id='HalfCheetah_F',
        entry_point='cs285.envs.cheetah.cheetah_F:HalfCheetah_F',
        max_episode_steps=1000,
    )
